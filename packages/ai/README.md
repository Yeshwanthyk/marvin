...
```bash
npm install @mu-agents/ai
```

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@mu-agents/ai';
...
```typescript
import { Type, Tool, StringEnum } from '@mu-agents/ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@mu-agents/ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@mu-agents/ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@mu-agents/ai';
...
```typescript
import { getModel, stream } from '@mu-agents/ai';
...
```typescript
import { getProviders, getModels, getModel } from '@mu-agents/ai';
...
```typescript
import { Model, stream } from '@mu-agents/ai';
...
```typescript
import { getModel, complete, Context } from '@mu-agents/ai';
...
```typescript
import { Context, getModel, complete } from '@mu-agents/ai';
...
```typescript
import { agentLoop, AgentContext, calculateTool } from '@mu-agents/ai';
...
```typescript
import { agentLoopContinue, AgentContext } from '@mu-agents/ai';
...
```typescript
import { Type, Static, AgentTool, AgentToolResult, StringEnum } from '@mu-agents/ai';
...
```typescript
import { calculateTool, getCurrentTimeTool } from '@mu-agents/ai';
...
```typescript
import { setApiKey, getApiKey } from '@mu-agents/ai';
